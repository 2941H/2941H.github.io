    ...
    view! {
        section::Section(breakpoint="lg") {
            ...
            r#box::Box(class="mx-auto mt-8 lg:m-8 lg:absolute lg:right-0 lg:top-1/2 lg:-translate-y-1/2 w-fit h-fit") {
                ...
                img(src="./assets/givealittle_logo.webp", class="w-40 mt-8 mx-auto")
            }
            r#box::Box(class="lg:absolute m-8 lg:bottom-0 lg:m-0 lg:left-8 lg:bottom-8 lg:w-100 text-white text-xl") {
